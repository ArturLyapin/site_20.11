# RailsAdmin config file. Generated on November 19, 2012 17:10
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Contact', 'Feedback']

  # Include specific models (exclude the others):
  # config.included_models = ['Contact', 'Feedback']
